...
if (!Math) {
  (_easycom_uni_nav_bar + AuditCell)();
}
const AuditCell = () => "../../../components/AuditCell.js";
const _sfc_main = {
  __name: "audit",
  setup(__props) {
    const listData = [
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Workspace/code/web/uni-app/2023/warm_sun/pages/operator/audit/audit.vue"]]);
